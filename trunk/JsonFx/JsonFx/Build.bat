...
%1ScriptCompactor\ScriptCompactor.exe "%2Scripts\JSON.js" "%2Scripts\Compacted\JSON.js" "http://json.org/js.html"
...
%1ScriptCompactor\ScriptCompactor.exe "%2Scripts\JsonFx.js" "%2Scripts\Compacted\JsonFx.js" "Copyright (c)2006-2007 Stephen M. McKamey. http://JsonFx.net"
