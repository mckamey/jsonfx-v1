		...
		/*DOM*/ function aa(/*DOM*/ el, /*object*/ a) {
			if (a.name && ie) {
				try {
					...
					var el2 = a.type && el.tagName === "input" ?
						ie.innerHTML("<"+el.tagName+" type='"+a.type+" name='"+a.name+"'>").firstChild :
						document.createElement("<"+el.tagName+" name='"+a.name+"'>");
