...
if ("undefined" === typeof window.jQuery) {
	throw new Error("JsonFx_UA.js requires jquery.js");
}
...
jQuery(function() {
	...
	// calculate userAgent categories
	/*Dictionary<string,string>*/ var fxua = JsonFx.UA.parseUserAgent(navigator.userAgent);

	// append CSS classes to document.body based upon user-agent
